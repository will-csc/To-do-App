...
code.bind("<Return>",lambda event: forget_password(code.get(),new_password.get(),new_password2.get(),window))
new_password.bind("<Return>",lambda event: forget_password(code.get(),new_password.get(),new_password2.get(),window))
new_password2.bind("<Return>",lambda event: forget_password(code.get(),new_password.get(),new_password2.get(),window))
