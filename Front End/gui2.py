from functions import relative_to_assets, save_file, get_name,search_file,delete_file, circular_image, file_content, set_placeholder, update_last_folder
...
def get_date(day,month,year):
    ...
    save_file(filename.get() + ".md",date,get_name(), user_input.get("1.0", "end-1c"))
...
save_9 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: get_date(deadlineday.get(),deadlinemonth.get(),deadlineyear.get()),
    relief="flat",
    bg="#1D7373"
)
save_9.place(
