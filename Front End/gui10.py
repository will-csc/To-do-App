...
from functions import relative_to_assets, set_placeholder, get_name, circular_image, file_content, search_file,month_days, createimage_button, update_last_folder, open_calendar
...
centralize_window(window,1130,739)
