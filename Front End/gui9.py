...
from functions import relative_to_assets, search_file, get_name, circular_image, file_content, search_file, set_placeholder, createimage_button, update_last_folder, open_calendar
...
find_1.bind("<Return>", lambda: search_file(window,find_1.get()))
...
for file in displayed_files:
    ...
    if idx is not None and len(semana_files[idx]) < 5:
