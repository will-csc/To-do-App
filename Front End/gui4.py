...
from functions import relative_to_assets, search_file, get_name, circular_image, file_content, set_placeholder, createimage_button, update_last_folder, open_calendar
...
today_image_12 = relative_to_assets("today_marked.png")
today_12 = Button(
...
for file in displayed_files:
    createimage_button(
        ...
        imagem_base_path=ASSETS_PATH / "medium_note.png",
